...
from layers.dmon import DMoN

class GCNDMoN(nn.Module):
    """GCN model with Modularity pooling layer.
    ...
    Args:
        ...
        collapse_regularization (float): Peso para la regularización de colapso
...
def gcn_dmon(input_dim: int,
             channel_sizes: List[int],
             collapse_regularization: float = 0.1,
             dropout_rate: float = 0.0,
             pooling_mlp_sizes: Optional[List[int]] = None,
             renyi_loss: float = 0.0) -> nn.Module:
    """Función constructora para el modelo GCNDMoN.
    ...
    Args:
        ...
        collapse_regularization: Peso para la regularización de colapso
        dropout_rate: Tasa de dropout
        pooling_mlp_sizes: Tamaños de las capas ocultas del MLP en la capa de pooling
        renyi_loss: Peso para la pérdida de Renyi
        
    Returns:
        Modelo GCNDMoN inicializado
    """
    return GCNDMoN(
        input_dim,
        channel_sizes,
